...
.w-100.h-100
  ...
  transition-group(name="fade", mode="out-in", v-else)
    .d-flex.flex-wrap.justify-content-between(key="loaded")
      .col-12.px-0(v-if="checkLevel(['settings:cameras:edit', 'settings:notifications:edit'])")
      ...
      b-collapse.w-100(
        ...
        .col-12.mt-2.px-0(data-aos="fade-up" data-aos-duration="1000" v-if="checkLevel(['settings:cameras:edit', 'settings:notifications:edit'])")
